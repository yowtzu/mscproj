...
\begin{equation}
  \hat{y}^{ref}_{t+1} = y^{ref}_{t} + \beta k
\end{equation}
where $\beta$ is the EWMA estimate ($\lambda = 0.94$) of the daily changes of $y^{ref}$ up to time step $t$. This estimator is used just for simplicity sake. Other estimators are possible.
